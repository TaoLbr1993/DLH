...
int main(int argc, char **argv) {
    ...
    std::ofstream fout(out_dir + "/GHNSW-V5_stats.log", std::ios::out | std::ios::trunc);
    fout << oss.str();
    std::cout << "日志写入: " << (out_dir + "/GHNSW-V5_stats.log") << std::endl;
    ...
    memlog.dump_to_file(out_dir + "/GHNSW-V5_memstat.log");
